/datum/quirk/body_morpher
	...
	desc = "Каким-то образом вы развили способность, позволяющую вашему телу морфировать и изменять свои части тела, подобно тому, как это может делать слаймик. Это ЕРП квирк, за использование его в целях робаста вы получите наказание"
	value = 0
